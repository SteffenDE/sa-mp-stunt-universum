...
forward DestroyTurismo(playerid);
forward DestroyBullet(playerid);
forward TuneCar();
...
//personal turismo
new PVehh[MAX_PLAYERS];

//personal bullet
new PVehhh[MAX_PLAYERS];
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	AddStaticPickup( 347,2,3819.7971,-1926.9595,13.3730); //Silenced 9mm
	AddStaticPickup( 347,2,3819.7971,-1926.9595,13.3730); //Silenced 9mm
    AddStaticVehicleEx(470,766.5181,-3202.3389,10.4584,324.6010,12,117,120); // car 1
    AddStaticVehicleEx(470,684.8655,-3210.9490,14.3715,294.8617,12,117,120); // car 2
    AddStaticVehicleEx(470,780.0691,-3165.8521,5.1196,271.6620,12,117,120); // car 3
    AddStaticVehicleEx(470,760.7960,-3143.4924,5.1206,128.2190,12,117,120); // car 4
    AddStaticVehicleEx(470,814.0949,-3036.7827,3.8683,194.6881,12,117,120); // car 5
    AddStaticVehicleEx(470,786.1233,-3080.9084,5.1205,221.9377,12,117,120); // car 6
    AddStaticVehicleEx(470,746.5602,-3107.0640,5.1269,231.9366,12,117,120); // car 7
    AddStaticVehicleEx(470,700.3429,-3139.2886,3.8141,1.1423,12,117,120); // car 8
    AddStaticVehicleEx(470,663.6981,-3057.2844,16.6590,221.2981,12,117,120); // car 9
    AddStaticVehicleEx(470,756.8775,-3051.0784,5.0707,126.5434,12,117,120); // car 10
    AddStaticVehicleEx(432,703.0618,-3150.6394,2.6808,284.2815,0,7,120); // tank 1
    CreateObject(17472, 799.929199, -3011.671387, -0.466896, 0.0000, 0.0000, 11.2500);
    CreateObject(16593, 753.627563, -3131.470215, 7.768036, 0.0000, 0.0000, 0.0000);
    CreateObject(17472, 664.805603, -3248.904541, 7.064263, 0.0000, 0.0000, 191.2500);
    CreateObject(17472, 660.296814, -3213.209473, 7.727077, 0.0000, 0.0000, 78.7500);
    CreateObject(17472, 699.595337, -3234.142822, 6.334896, 0.0000, 0.0000, 191.2500);
    CreateObject(17472, 647.177551, -3069.294189, 5.311836, 0.0000, 0.0000, 101.2500);
    CreateObject(17472, 673.930786, -3037.175537, 6.911835, 0.0000, 0.0000, 11.2500);
    CreateObject(17472, 662.924683, -3097.622070, 7.649414, 0.0000, 0.0000, 101.2500);
    CreateObject(17472, 671.716248, -3127.499512, 3.174164, 0.0000, 0.0000, 101.2500);
    CreateObject(17472, 678.543213, -3170.452637, -0.759741, 0.0000, 0.0000, 78.7500);
    CreateObject(17472, 736.785767, -3225.079346, 5.996887, 0.0000, 0.0000, 191.2500);
    CreateObject(17472, 779.051208, -3227.788818, 6.892962, 0.0000, 0.0000, 168.7500);
    CreateObject(17472, 831.516113, -3237.369141, 5.224483, 0.0000, 0.0000, 191.2500);
    CreateObject(17472, 854.789368, -3198.252197, 6.330169, 0.0000, 0.0000, 281.2500);
    CreateObject(17472, 857.664001, -3148.998779, 8.885363, 0.0000, 0.0000, 281.2500);
    CreateObject(17472, 852.259338, -3100.796143, 10.678417, 0.0000, 0.0000, 292.5000);

...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(CurrentMenu == DMZones)
	{
    	switch(row)
    	{
        	...
        	{
			    ResetPlayerWeapons(playerid);
                SetPlayerPos(playerid, 813.9166,-3206.0054,6.6033);
...
public OnPlayerConnect(playerid)
{
	...
	Textdraw0 = TextDrawCreate(3.000000,344.000000,"s t u n t  u n i v e r s u m");
	...
	if(!strcmp("illegalplayername1",pName,true) || !strcmp("illegalplayername2",pName,true) || !strcmp("illegalplayername3",pName,true))
	{
	    new kstring[128];
	...
	SendClientMessage(playerid, COLOR_BASIC, "Willkommen auf der Map .:STUNT UNIVERSE:. by steffend (forked from Fallout)!");
	...
	SendClientMessage(playerid, COLOR_BASIC, "Last update: Alle Stunts wieder da.");
...
public OnPlayerDisconnect(playerid, reason)
{
    ...
    if( PVehh[playerid] > 0 )
    {
        SetTimerEx("DestroyTurismo",10000,0, "i", playerid);
        SetVehiclePos(PVeh[playerid], 0, 0, 0);
    }

    if( PVehhh[playerid] > 0 )
    {
        SetTimerEx("DestroyBullet",10000,0, "i", playerid);
        SetVehiclePos(PVeh[playerid], 0, 0, 0);
    }
...
public OnPlayerDeath(playerid, killerid, reason)
{
    FadePlayerScreen(playerid, 0xFFFFFFCC, 6, 192);
 	GameTextForPlayer(playerid,"~w~Du bist gestorben...",1000,1);
    SendDeathMessage(killerid, playerid, reason);
    GameTextForPlayer(killerid,"~r~Du Mörder!",4000,3);
    ...
    if( DMZone[killerid] == 0 )
    {
		...
		SendClientMessage(killerid, COLOR_RED, "Man soll niemanden außerhalb der DeathMatch Zonen töten!");
	}
    return 1;
}
	...
	for(new i=0; i<MAX_PLAYERS; i++)
	{
		if(IsPlayerConnected(i))
		{
			if(IsPlayerInArea(i, -128.4566, 875.8406, 1272.888, 2767.656))
			{
                ...
                {
					GameTextForPlayer(i, "~w~Du hast die~n~~r~Las Venturas War Zone betreten.", 3000, 3);
...
public DestroyBullet(playerid)
{
        DestroyVehicle(PVehh[playerid]);
        PVehh[playerid] = 0;
        print("A PVehh has been destroyed !");
}

public DestroyTurismo(playerid)
{
        DestroyVehicle(PVehhh[playerid]);
        PVehhh[playerid] = 0;
        print("A PVehhh has been destroyed !");
}
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(strcmp(cmdtext, "/fix", true) == 0)
	{
    	if(GetPlayerState(playerid) == PLAYER_STATE_DRIVER)
    	{
            ...
            else if(DMZone[playerid] == 4)
            {
                SendClientMessage(playerid,COLOR_RED,"You are not allawed to repair your vehicle in /IslandDM.");
            }
        	else
        	{
            	SetVehicleHealth(GetPlayerVehicleID(playerid),1000.0);
    ...
    if(strcmp(cmdtext, "/turismo", true)==0)
    {
        if( PVehh[playerid] > 0 )
        {
            if(GetPlayerVehicleID(playerid) !=  PVehh[playerid])
            {
                if(IsPlayerInAnyVehicle(playerid))
                {
                    RemovePlayerFromVehicle(playerid);
                ...
                GetPlayerFacingAngle(playerid, Ang);
                GetPlayerName(playerid, Name, sizeof( Name ));
                PutPlayerInVehicle(playerid, PVehh[playerid], 0);
                SetVehiclePos(PVehh[playerid], X, Y, Z);
                SetVehicleZAngle(PVehh[playerid], Ang);
                SetVehicleHealth(PVehh[playerid],  1000.0);
                LinkVehicleToInterior(PVehh[playerid], GetPlayerInterior(playerid));
                SendClientMessage(playerid,COLOR_BASIC, "personal turismo called.");
                PlayerPlaySound(playerid, 1085, 0.0, 0.0, 0.0);
            }
            else
            {
                SendClientMessage(playerid,COLOR_RED, "You are already on your personal turismo.");
            }
        }
        else
        {
            ...
            GetPlayerFacingAngle(playerid, Ang);
            GetPlayerName(playerid, Name, sizeof( Name ));
            PVehh[playerid] = CreateVehicle(451, X, Y , Z, Ang, 75,3, 5000000);
            PutPlayerInVehicle(playerid, PVehh[playerid], 0);
            LinkVehicleToInterior(PVehh[playerid], GetPlayerInterior(playerid));
            printf("personal turismo created for %s.", Name);
            SendClientMessage(playerid,COLOR_BASIC, "personal turismo created.");
            PlayerPlaySound(playerid, 1085, 0.0, 0.0, 0.0);
            SetVehicleParamsForPlayer(PVehh[playerid], playerid, 0, 0);
            for(new i=0; i <= MAX_PLAYERS; i++)
            {
                if ( IsPlayerConnected(i) )
                {
                    if ( i != playerid )
                    {
                        SetVehicleParamsForPlayer(PVehh[playerid], i, 0, 1);
                    }
                }
            }
        }
    ...
    if(strcmp(cmdtext, "/bullet", true)==0)
    {
        if( PVeh[playerid] > 0 )
        {
            if(GetPlayerVehicleID(playerid) !=  PVeh[playerid])
            {
                ...
                SetVehicleHealth(PVeh[playerid],  1000.0);
                LinkVehicleToInterior(PVeh[playerid], GetPlayerInterior(playerid));
                SendClientMessage(playerid,COLOR_BASIC, "personal bullet called.");
                PlayerPlaySound(playerid, 1085, 0.0, 0.0, 0.0);
            }
            else
            {
                SendClientMessage(playerid,COLOR_RED, "You are already on your personal bullet.");
            }
        }
        else
        {
            ...
            GetPlayerFacingAngle(playerid, Ang);
            GetPlayerName(playerid, Name, sizeof( Name ));
            PVeh[playerid] = CreateVehicle(541, X, Y , Z, Ang, 75,3, 5000000);
            PutPlayerInVehicle(playerid, PVeh[playerid], 0);
            LinkVehicleToInterior(PVeh[playerid], GetPlayerInterior(playerid));
            printf("personal bullet created for %s.", Name);
            SendClientMessage(playerid,COLOR_BASIC, "personal bullet created.");
            PlayerPlaySound(playerid, 1085, 0.0, 0.0, 0.0);
            SetVehicleParamsForPlayer(PVeh[playerid], playerid, 0, 0);
            for(new i=0; i <= MAX_PLAYERS; i++)
            {
    ...
    if(strcmp(cmd, "/weather", true) == 0)
    {
        ...
        new value[5];
        value[1] = idx;
        new weatherval = strval(value[1]);

        if(weatherval >= 1 && weatherval <= 20) {
            SetPlayerWeather(playerid, weatherval);
            new stringg[50];
            format(stringg, sizeof(stringg), "Weather set do %d", idx);
            SendClientMessage(playerid, COLOR_BASIC, stringg);
            return 1;
        }

        else if(!strlen(tmp)) {
            SendClientMessage(playerid, COLOR_BASIC, "USAGE: /weather [1-20]");
            return 1;
        }

        else if(weatherval > 20) {
            SendClientMessage(playerid, COLOR_BASIC, "USAGE: /weather [1-20]");
            return 1;
        }
